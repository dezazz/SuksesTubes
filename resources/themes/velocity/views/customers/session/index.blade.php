        ...
        {!! view_render_event('bagisto.shop.customers.login.before') !!}
            ...
            <div class="container">
                <div class="offset-lg-1">
                    <div class="heading d-flex justify-content-between align-items-center col-6">
                        <h2 class="fs24 fw6">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <div class="body col-8 shadow">
                            ...
                            <form
                                ...
                                <div class="form-group hover" :class="[errors.has('email') ? 'has-error' : '']">
                        ...
                        <div class="d-flex justify-content-center align-items-center m-3">
                            <img src="{{ asset('/themes/velocity/assets/images/tes1.png') }}" alt="Ini gambar" width="400">
                        </div>
                    </div>
                </div>
            </div>
